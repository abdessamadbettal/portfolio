...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Web Developer 🚀 having an experience of building Web and Mobile applications with Laravel, JavaScript / Reactjs,Vue / Nodejs / Next.js and some other cool libraries and frameworks."
  ),
  resumeLink:
